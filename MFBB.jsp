        ...
        <div class="view">
          <div class="align">
            <span class="view_com"
              ><a href="POST.jsp"
                ><div class="view_com__Img">
                  <img src="img/post1.jpg" alt="" class="view_com__Img_img" />
                </div>
                <div class="view_com__Title"> 목포 항구 축제</div></a
              >
            </span>
            ...
            <span class="view_com"
              ><a href="POST2.jsp"
                ><div class="view_com__Img">
                  <img src="img/slide2.jpg" alt="" class="view_com__Img_img" />
                </div>
                <div class="view_com__Title"> 전남국제수묵비엔날레</div></a
              >
            </span>
          </div>
          ...
          <div class="align">
            <span class="view_com">
              <a href="POST3.jsp"
                ><div class="view_com__Img">
                <img src="img/slide4.png" alt="목포세계마당페스티벌" class="view_com__Img_img" />
              </div>
              <div class="view_com__Title">목포세계마당페스티벌</div></a>
            </span>

            <span class="view_com">
              <a href="POST4.jsp">
              <div class="view_com__Img">
                <img src="img/slide5-1.png" alt="" class="view_com__Img_img" />
              </div>
              <div class="view_com__Title">목포 해상 w쇼</div></a>
            </span>
          </div>
          ...
          <div class="align">
            <span class="view_com">
              <a href="POST5.jsp">
              <div class="view_com__Img">
                <img src="img/slide3-1.png" alt="" class="view_com__Img_img" />
              </div>
              <div class="view_com__Title">목포 유달산 봄축제</div></a>
            </span>

            <span class="view_com">
              <a href="POST6.jsp">
              <div class="view_com__Img">
                <img src="img/slide6-1.png" alt="" class="view_com__Img_img" />
              </div>
              <div class="view_com__Title">목포 항구 버스킹</div></a>
            </span>
          </div>
        </div>
      </div>
