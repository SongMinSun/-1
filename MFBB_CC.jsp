...
<html lang="en">
  ...
  <body>
    <div class="header">
      <a href="MFBB_CC.jsp"><img src="logo3.png" class="img_logo" /></a>
    </div>
    <%
              ...
              <%
    	          ...
    	          Connection conn ;
		            try{
			              ...
			              String sql = "select num, username, title, time, hit, indent from board3 order by ref desc, step asc";
...
<%
    ...
    %>
    <div class="write_btn" OnClick="window.location='CC_write.jsp'">
          <b >글쓰기</a>
