              ...
              <%
    	          ...
    	          Connection conn ;
		            try{
			              ...
			              String sql = "select num, username, title, time, hit, indent from board order by ref desc, step asc";
...
%> 
                ...
                <a href="FAQ_view.jsp?idx=<%=idx%>"> <%=title %></a></td>
                <td><%=name %></td>
                <td><%=time %></td>
                <td><%=hit %></td>
              </tr>
...
<%
    ...
    %>
    <div class="write_btn" OnClick="window.location='FAQ_write.jsp'">
          <b >글쓰기</a>
