...
<%
    ...
    %>
      <input class="write_btn" type=button value="삭제" OnClick="window.location='C_delete.jsp?idx=<%=idx%>'">
      <input class="write_btn" type=button value="수정" OnClick="window.location='C_modify.jsp?idx=<%=idx%>'">
    <%
    } else {
    %>
...
<input class="write_btn" type=button value="답글" OnClick="window.location='C_reply.jsp?idx=<%=idx%>'">
