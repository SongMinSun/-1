  ...
  <head>
    ...
    %>
        ...
        <div class="column_middle">
            <div id="wrap">
                <h2>게시글 작성</h2>
                <form name=replyform method=post action="FAQ_reply_ok.jsp?idx=<%=idx%>">
                    ...
                    /></td>
                        ...
                        <tr>
                            <th>내용</th>
                            <td><textarea cols="100" rows="30" name="memo"></textarea></td>
                        </tr>
                    </table>
                    <input class="write_btn" type="submit" value="등록" onclick="javascript:replyCheck()">
