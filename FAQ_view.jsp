...
<%
    ...
    %>
      <input class="write_btn" type=button value="삭제" OnClick="window.location='FAQ_delete.jsp?idx=<%=idx%>'">
      <input class="write_btn" type=button value="수정" OnClick="window.location='FAQ_modify.jsp?idx=<%=idx%>'">
...
<input class="write_btn" type=button value="답글" OnClick="window.location='FAQ_reply.jsp?idx=<%=idx%>'">
